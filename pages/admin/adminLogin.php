<?php 
 ...
 header("Set-Cookie: key1=value; path=/; HttpOnly; SameSite=None");
...
.login > header {
  ...
  box-shadow: 1px 3px 3px 1px rgba(0, 0, 0, 0.14),
              1px 2px 6px 1px rgba(0, 0, 0, 0.12),
              1px 4px 2px -2px rgba(0, 0, 0, 0.2);
}
    ...
    <div class="login-container">
      <section class="login" id="login">
        ...
        <form class="login-form" action="#" method="post">
          <input type="text" class="login-input" placeholder="User" name="userName" id="userName"required autofocus/>
          <input type="password" class="login-input" placeholder="Password" name="password" id="password"required/>
          <div class="submit-container">
            <button type="submit" class="login-button" name="adminLogin" id="adminLogin">SIGN IN</button>
          </div>
        </form>
      </section>
    </div>
