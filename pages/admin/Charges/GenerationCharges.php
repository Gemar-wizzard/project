<nav>
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
    <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true"><strong>Add Generation Charges</strong></a>
    <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false"><strong>View Generation Charges</strong></a>
  ...
  <div class="modal-dialog modal-confirm">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button class="btn btn-success btn-block" data-dismiss="modal" id="generationCharges">OK</button>
      </div>
    </div>
  </div>
</div>     
...
<div class="table-responsive">
  ...
  <div>
     ...
     $sql = "SELECT * FROM generationcharges WHERE status!='5'";
           ...
           echo "</thead>";
             ...
             while($row = mysqli_fetch_array($result)){
              echo "<tr class='winner__table'>";
                  echo "<td>" . $row['idgenerationCharges'] . "</td>";
                  echo "<td>" . $row['generationName'] . "</td>";
