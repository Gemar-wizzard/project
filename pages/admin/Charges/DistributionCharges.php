<nav>
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
    <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true"><strong>Add Distribution Charges</strong></a>
    <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false"><strong>View Distribution Charges</strong></a>
        ...
        <form>
          <div class="form-row">
            <div class="form-group col-md-6">
              <label for="charges">Charges Name</label>
  ...
  <div class="modal-dialog modal-confirm">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button class="btn btn-success btn-block" data-dismiss="modal" id="distributionModal">OK</button>
      </div>
    </div>
  </div>
</div>     
...
<div class="table-responsive">
  ...
  <div>
     ...
     $sql = "SELECT * FROM distributioncharge WHERE status!='5'";
      ...
      if(mysqli_num_rows($result) > 0){
        echo "<div class='scroll'>";
          ...
          echo "<thead class='table__head'>";
            echo "<tr>";
              echo "<th>ID</th>";
              echo "<th>Distribution Charges</th>";
              echo "<th>Amount</th>";
              echo "<th>Status</th>";
               echo "<th>Action</th>";
            echo "</tr>";
           echo "</thead>";
             ...
             while($row = mysqli_fetch_array($result)){
              echo "<tr class='winner__table'>";
                  echo "<td>" . $row['iddistributionCharge'] . "</td>";
                  echo "<td>" . $row['distributionName'] . "</td>";
                  echo "<td>" . $row['amount'] . "</td>";
                  echo "<td>" . $row['status'] . "</td>";
                  echo "<td>
                  <button type='button' class='btn btn-info btn-sm data-toggle='tooltip' title='Activate' id='toChange'data-toggle='modal' data-target='#activation' onclick='actDeact(".$row['iddistributionCharge'].",".$row['status'].")><i class='fas fa-check-square'></i></button>
            ...
            <div class="modal-header">
             ...
             <div class="modal-body">
              <form method="post">
               ...
               <button type="submit" name="activateDeactivate" class="btn btn-success btn-lg" id="activateDeactivate"><span class="glyphicon glyphicon-ok-sign"></span>Submit</button>     
             </form>
             </div>
