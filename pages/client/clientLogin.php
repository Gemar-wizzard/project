    ...
    <div class="login-container">
      <section class="login" id="login">
        ...
        <form class="login-form" action="#" method="post">
          <input type="text" class="login-input" placeholder="Account Number" name="accountNumber" id="accountNumber"required autofocus/>
          <input type="password" class="login-input" placeholder="Meter Number" name="meterNumber" id="meterNumber" required/>
          <div class="submit-container">
            <button type="submit" name="login-buttonutton" class="login-button" id="loginButton">SIGN IN</button>
          </div>
        </form>
